...
unlink(here('SensitivityAnalysis','Heterogeneity','MR_res_gwas.xlsx'))
unlink(here('SensitivityAnalysis','Heterogeneity','MR_dat_gwas.xlsx'))
...
for (i in 1:length(out)){
  ...
  write.xlsx(table,here("SensitivityAnalysis","Heterogeneity","MR_res_gwas.xlsx"),sheetName = out[i],append = TRUE)
  write.xlsx(dat,here("SensitivityAnalysis","Heterogeneity","MR_dat_gwas.xlsx"),  sheetName = out[i], append = TRUE)
