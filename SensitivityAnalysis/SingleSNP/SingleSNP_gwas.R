...
for (i in 1:length(out)){
  ...
  write.xlsx(table,here("SensitivityAnalysis","SingleSNP","MR_res_gwas.xlsx"),sheetName = out[i],append = TRUE)
  write.xlsx(dat,here("SensitivityAnalysis","SingleSNP","MR_dat_gwas.xlsx"),  sheetName = out[i], append = TRUE)
