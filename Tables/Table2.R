...
#   mutate(rs6503468 = if_else(ped$rs6503468.1 == "C" & ped$rs6503468.2 == "C", 1,rs6503468),
...
#          
#          rs7220711 = if_else(ped$rs7220711.1 == "G" & ped$rs7220711.2 == "G", 1,rs7220711),
...
# ------------------------------------------------------------------------------
ukb_tab <- read.csv(here("Data","UKB","ukb669864_Table2.csv"))
