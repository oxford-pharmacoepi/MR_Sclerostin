...
Previously, you must ensure that you have a directory "${folder directory}\MR_Sclerostin_Data" with the following files:
  ...
  - NatureGenetics\NatureGenetics_GWAS1.txt: GWAS summary statistics by Ferkingstad et al. (2021). Can be dowloaded from: Corresponds to the file "SeqId_GeneName_ProteinName.txt.gz".
  - NatureGenetics\NatureGenetics_GWAS2.txt: GWAS summary statistics by Ferkingstad et al. (2021). Can be dowloaded from: Corresponds to the file "assocvariants.annotated.txt.gz".
