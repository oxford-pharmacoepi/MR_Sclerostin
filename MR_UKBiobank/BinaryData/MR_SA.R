...
# write.xlsx(table,here("MR_UKBiobank","BinaryData",type,"MR_res.xlsx"),sheetName = outc, append = TRUE)
# write.xlsx(dat,here("MR_UKBiobank","BinaryData",type,"MR_dat.xlsx"),  sheetName = outc, append = TRUE)
...
write.xlsx(data.frame(SNPS = c("All",dat$SNP),
                      ...
                      SE = loo[,2],
                      pval = loo[,3]),
           here("SensitivityAnalysis","LeaveOneOut","BinaryData_SA","loo.xlsx"),  sheetName = outc, append = TRUE)
